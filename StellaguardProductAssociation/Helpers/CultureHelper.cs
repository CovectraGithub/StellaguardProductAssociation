...
namespace AuthentiTrack.UI.Helpers
{
    public static class CultureHelper
    {
        ...
        //public static List<SeedLanguage> GetLanaguage()
        //{
        //    Language lg = new Language();
        //    List<SeedLanguage> listLanguage = new List<SeedLanguage>();

        //    try
        //    {
        //        using (UserManagerServiceClient service = new UserManagerServiceClient())
        //        {
        //          var  result= service.GetLanguageList();
        //          listLanguage = result.ListLanguage.Select<Language, SeedLanguage>(l =>
        //          {
        //              return new SeedLanguage
        //              {
